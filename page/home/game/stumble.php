...
<div class="container">
    <div class="item">
        <div class="bg">
            <img src="assets/img/bgSTUMBLE.png" alt="..." style="width: 400px; height: 200px">
        </div>
        <div class="teks">
            <h2 class="text-start" style="margin-top:10px">Stumble Guys</h2>
            ...
            <p>Unduh dan mainkan Stumble Guys sekarang!</p>
            <a href="https://apps.apple.com/us/app/stumble-guys/id1541153375"><img src="assets/img/app.png" alt=""></a>
            <a href="https://play.google.com/store/apps/details?id=com.kitkagames.fallbuddies&hl=en&gl=US&pli=1"><img
    ...
    <div class="item">
        <div class="item-list">
            ...
            <div class="item-item">
                <div class="list-item" onclick="changeColor(this, '250 Gems', '10811')">
                    <img src="assets/img/diamond.png" alt="">
                    <p><strong>250 Gems</strong></p>
                    <p style="color: red"><strong>Rp. 10.811</strong></p>
                </div>
                <div class="list-item" onclick="changeColor(this, '800 Gems', '28378')">
                    <img src="assets/img/diamond.png" alt="">
                    <p><strong>800 Gems</strong></p>
                    <p style="color: red"><strong>Rp. 28.378</strong></p>
                </div>
                <div class="list-item" onclick="changeColor(this, '1600 Gems', '49815')">
                    <img src="assets/img/diamond.png" alt="">
                    <p><strong>1600 Gems</strong></p>
                    <p style="color: red"><strong>Rp. 49.815</strong></p>
                </div>
                <div class="list-item" onclick="changeColor(this, '5000 Gems', '112613')">
                    <img src="assets/img/diamond.png" alt="">
                    <p><strong>5000 Gems</strong></p>
                    <p style="color: red"><strong>Rp. 112.613</strong></p>
                </div>
            </div>
        </div>
        <!-- <br>
    <div class="item-list">
      ...
      <div class="item-item">
        ...
        <form method="POST">
            ...
            <?php
            //query ke tabel sesuai dengan ID yang ada di URL
            $ml = mysqli_query($koneksi, "SELECT nama_game FROM game WHERE id_game=6");
